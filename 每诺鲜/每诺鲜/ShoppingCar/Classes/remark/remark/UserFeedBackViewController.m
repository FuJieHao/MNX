...
-(PlaceholderTextView *)textView{
    ...
    if (!_textView) {
        ...
        _textView.placeholder = @"在这里留下你的备注吧~";
...
//        if (self.emailRight != 0 || self.phoneRight != 0) {
            ...
            UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"提交成功" message:@"亲你的备注信息我们已经收到" preferredStyle:UIAlertControllerStyleAlert];
