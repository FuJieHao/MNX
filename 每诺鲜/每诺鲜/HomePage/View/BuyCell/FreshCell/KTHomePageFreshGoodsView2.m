...
@interface KTHomePageFreshGoodsView2 () <buyViewDelegate>
...
@implementation KTHomePageFreshGoodsView2
...
- (void)setModel:(KTHPFreshGoods2Model *)model
{
    _model = model;
